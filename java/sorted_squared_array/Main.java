...
public class Main {
    ...
    public static void main(String[] args) {
        // Test cases: (input array) -> Expected output sorted squared array
        int[][] testCases = {
        ...
        for (int i = 0; i < testCases.length; i++) {
            ...
            int[] result = SortedSquaredArray.getSortedSquaredArray(array);
            System.out.println("Test case " + (i + 1) + ": Array = " + Arrays.toString(array) + 
